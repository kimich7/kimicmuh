...
//----還沒帶入----
//篩選後給每頁的筆數
$sqlstr_page="SELECT id,bid,fid,eid,rdate,datekind,tid,macNo,remark,emp,sremp,cemp,status FROM FA.MMT_GtableM  ORDER BY rdate ASC OFFSET $startRow_record ROWS FETCH NEXT $pageRow_record ROWS ONLY";
