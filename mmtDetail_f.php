...
<body class="table_bg">
    ...
    <form action="" method="post" name="mmt_Detailtable_f">
        ...
        <table class="table my-5">
            ...
            <tr>
                ...
                <?php switch ($choicedata) {
                    case '1':?>
                        <td colspan='3'>斷電測試電壓：<input type='text' name='va[]' maxlength='20' value="<?= $z[0] ?>" disabled>V</td>
                        <?PHP
                        break;
                    
                    case '2':?>
                        <td colspan='3'>運轉電流：<input type='text' name='va[]' maxlength='20' value="<?= $z[0] ?>" disabled>A</td>
                        <?PHP
                        break;
                    
                    case '3':?>
                        <td colspan='3'>運轉電流：主<input type='text' name='va[1]' maxlength='20' value="<?= $z[0] ?>" disabled>A&nbsp輔：<input type='text' name=$va[2] maxlength='20' value="<?= $z[2] ?>" disabled></td>
                        <?PHP
                        break;
                }
                 ?>
            ...
            <tr>
                ...
                <?php switch ($choicedata) {
                    ...
                    case '3':?>
                        <td colspan='3'>運轉電流：主<input type='text' name='va[]' maxlength='20' value="<?= $z[0] ?>" disabled>A&nbsp輔：<input type='text' name='va[]' maxlength='20' value="<?= $z[2] ?>" disabled>A</td>
                        <?PHP
                        break;
                }
                 ?>
        ...
        <div class="input-group">
            ...
            <textarea class="form-control" name="remark" aria-label="With textarea" disabled><?= $reportS1[0]['remark'].'|'.$reportS2[0]['remark'].'|'.$reportS3[0]['remark'].'|'.$reportS4[0]['remark'] ?></textarea>
        </div>       
