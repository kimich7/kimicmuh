        ...
        $totalstr_num="SELECT COUNT(case_id) FROM FA.Abnormal_Notification_System_Master WHERE work_emp = '$userID'";        
            ...
            switch ($x) {
                ...
                case 1://只有keyword
                    ...
                    $sqlstr_total="SELECT a.* FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Employee as b on a.case_userID=b.e_number or a.case_manageID=b.e_number or a.work_emp=b.e_number where ( b.cname like '%$keyword%' or a.case_title like '%$keyword%' or a.case_location like '%$keyword%' or a.case_time like '%$keyword%' or a.confirm_date like '%$keyword%') AND work_emp ='$userID'";
                    //篩選後給每頁的筆數
                    $sqlstr_page="SELECT a.* FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Employee as b on a.case_userID=b.e_number or a.case_manageID=b.e_number or a.work_emp=b.e_number where ( b.cname like '%$keyword%' or a.case_title like '%$keyword%' or a.case_location like '%$keyword%' or a.case_time like '%$keyword%' or a.confirm_date like '%$keyword%') AND work_emp ='$userID' ORDER BY a.case_time DESC OFFSET $startRow_record ROWS FETCH NEXT $pageRow_record ROWS ONLY";
                   //總資料數量
                ...
                case 5://開始+keyword
                    //所有的資料 (check_manager IS NULL or check_manager=0) and
                    $sqlstr_total=" SELECT a.* FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Employee as b on a.case_userID=b.e_number or a.case_manageID=b.e_number or a.work_emp=b.e_number where ((a.case_time ='$start_date'or a.confirm_date= '$start_date') and ( b.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%')) AND work_emp ='$userID'";
                    //篩選後給每頁的筆數
                    $sqlstr_page="SELECT a.* FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Employee as b on a.case_userID=b.e_number or a.case_manageID=b.e_number or a.work_emp=b.e_number where ((a.case_time ='$start_date'or a.confirm_date = '$start_date') and ( b.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%')) AND work_emp ='$userID' ORDER BY a.case_time DESC OFFSET $startRow_record ROWS FETCH NEXT $pageRow_record ROWS ONLY";
                    //總資料數量
                    $totalstr_num="SELECT COUNT(case_id) FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Employee as b on a.case_userID=b.e_number or a.case_manageID=b.e_number or a.work_emp=b.e_number where ((a.case_time ='$start_date'or a.confirm_date = '$start_date') and ( b.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%')) AND work_emp ='$userID'";
                    break;
                case 6://結束+keyword
                    //所有的資料 (check_manager IS NULL or check_manager=0) and
                    $sqlstr_total=" SELECT a.* FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Employee as b on a.case_userID=b.e_number or a.case_manageID=b.e_number or a.work_emp=b.e_number where ((a.case_time='$end_date'or a.confirm_date = '$end_date')  and ( b.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%')) AND work_emp ='$userID'";
                    //篩選後給每頁的筆數
                    $sqlstr_page="SELECT a.* FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Employee as b on a.case_userID=b.e_number or a.case_manageID=b.e_number or a.work_emp=b.e_number where ((a.case_time='$end_date'or a.confirm_date = '$end_date')  and ( b.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%')) AND work_emp ='$userID' ORDER BY a.case_time DESC OFFSET $startRow_record ROWS FETCH NEXT $pageRow_record ROWS ONLY";
                    //總資料數量
                    $totalstr_num="SELECT COUNT(case_id) FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Employee as b on a.case_userID=b.e_number or a.case_manageID=b.e_number or a.work_emp=b.e_number where ((a.case_time='$end_date'or a.confirm_date = '$end_date')  and ( b.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%')) AND work_emp ='$userID'";
                    break;
                case 7://日期區間+keyword
                    //所有的資料 (check_manager IS NULL or check_manager=0) and
                    $sqlstr_total=" SELECT a.* FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Employee as b on a.case_userID=b.e_number or a.case_manageID=b.e_number or a.work_emp=b.e_number where ( (a.case_time between '$start_date' and '$end_date' or a.confirm_date between '$start_date' and '$end_date')and (b.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%')) AND work_emp ='$userID'";
                    //篩選後給每頁的筆數
                    $sqlstr_page="SELECT a.* FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Employee as b on a.case_userID=b.e_number or a.case_manageID=b.e_number or a.work_emp=b.e_number where ( (a.case_time between '$start_date' and '$end_date' or a.confirm_date between '$start_date' and '$end_date')and (b.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%')) AND work_emp ='$userID' ORDER BY a.case_time DESC OFFSET $startRow_record ROWS FETCH NEXT $pageRow_record ROWS ONLY";
                    //總資料數量
                    $totalstr_num="SELECT COUNT(case_id) FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Employee as b on a.case_userID=b.e_number or a.case_manageID=b.e_number or a.work_emp=b.e_number where ( (a.case_time between '$start_date' and '$end_date' or a.confirm_date between '$start_date' and '$end_date')and (b.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%')) AND work_emp ='$userID'";
                    break;                
            }
