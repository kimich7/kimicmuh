...
//所有的資料
$ammtmstr="SELECT fileNo,sdid,fileDownloadUserID,checkempId,fileDownloadDate,fileInsertDate,checkdate,eqlocation,fileCycle,filePath,remark,status FROM FA.MMA_getFile WHERE sdid=2";//全部資料
//總資料數量
$ammtmnumstr="SELECT Count(fileNo)FROM FA.MMA_getFile WHERE sdid=2 ";
$ammtmnum=Current($pdo->query($ammtmnumstr)->fetch());//全部數量
$total_num=$ammtmnum;

//----還沒帶入----
//篩選後給每頁的筆數
$sqlstr_page="SELECT fileNo,sdid,fileDownloadUserID,checkempId,fileDownloadDate,fileInsertDate,checkdate,eqlocation,fileCycle,filePath,remark,status FROM FA.MMA_getFile WHERE sdid=2 ORDER BY fileInsertDate ASC OFFSET $startRow_record ROWS FETCH NEXT $pageRow_record ROWS ONLY";
...
<body>
    ...
    <!--新增表單-->
    <form action="mmtCreate_b_other_choice.php" method="post" name="mmtca">
        <div class="panel-heading">
            <input type="hidden" name="mmtsysa" value=1>
            <div class="row my-3">                
                <div class="col">                    
