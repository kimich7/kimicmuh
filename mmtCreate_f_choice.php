...
<body onload="time_rota()">
    ...
    <form action="mmtCreate_f.php" method="get" name="formmmtchoicef">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-10 col-sm-10 col-12 back container w-50 my-4 rounded">
                    <div id="tablepanel" class="choice_table rounded text-white">                        
                        <div class="choice_table rounded text-white">
                            ...
                            <!-- 選擇季別 -->
                            <p>保養設備編號：</p>
                            <select class="form-control mb-3" name="mmtfseason" id="mmtfseason" required>
                                <option selected>請選擇保養季別</option>
                                <option value="S1">第一季(一~三月)</option>
                                <option value="S2">第二季(四~六月)</option>
                                <option value="S3">第三季(七~九月)</option>
                                <option value="S4">第四季(十~十二月)</option>                                
                            </select>
                            <!--工程名稱 -->
                            <P>保養設備大樓: </P>                                 
