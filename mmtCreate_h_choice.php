                    ...
                    <div id="tablepanel" class="choice_table rounded text-white">                        
                        <div class="choice_table rounded text-white">
                            ...
                            <div class="d-flex justify-content-end">                                
                                <span class="billBoardbuildL1 billBoardbuildL2 billBoardbuildL3" tabindex="0" data-toggle="tooltip" data-placement="bottom"
                                    title="請登入相應權限帳號已解鎖">
                                    <button style="pointer-events: none;" type="submit"
                                        class="btn btn-primary mt-4 buildL1 buildL2 buildL3" formtarget="_self" disabled>送出</button>
                                </span>
                            </div>
                        </div>
                    </div>
