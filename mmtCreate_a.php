<?php
    ...
    $mmtsysNo=$_POST["mmtsysa"];//保養系統代號
    $mmtsysName=sql_database('sName','MMT_sys','id',$mmtsysNo);//系統名稱
    $mmtbuildNo=$_POST["mmtbuilda"];//大樓代號
    $mmtbuildName=sql_database('bName','MMT_build','id',$mmtbuildNo);//大樓名稱
    $mmtfloorNo=$_POST["mmtfloora"];//樓層代號
    $mmtfloorName=sql_database('fName','MMT_floor','fid',$mmtfloorNo);//樓層名稱
    $mmtequipNo=$_POST["mmtequipa"];//設備代號
    $mmtequipName=sql_database('eName','MMT_equip','id',$mmtequipNo);//設備名稱
    $mmtequipNum=$_POST["mmtequipNoa"];//設備編號
