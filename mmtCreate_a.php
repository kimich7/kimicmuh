<?php
    ...
    if (isset($_POST["action"])&&($_POST["action"]=="add")) {
        ...
        for ($i=0; $i < $num; $i++) {                                    
            ...
            $reportCheck="SELECT COUNT(id) FROM FA.MMT_AtableM WHERE id='$mmt_a_m_id' ";
            ...
            if ($reportCheck_query ==0) {                    
                $insert_master_str="INSERT INTO FA.MMT_AtableM(id,bid,fid,eid,rdate,datekind,tid,macNo,remark,emp,status) VALUES ('$MMT_AtableMid','$bid','$fid','$eid','$rTime','$rdatekind','$tid','$macNo','$rmark','$remp','W') ";
                $insert_master =$pdo->exec($insert_master_str);                    
                
                $insert_detail_str="INSERT INTO FA.MMT_AtableD(checkid,ans,mid) VALUES ($check_id,'$ans','$MMT_AtableMid')";
