...
<body onload="time_rota()">
    ...
    <form action="mmtCreate_bl.php" method="get" name="formmmtchoicebl">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-10 col-sm-10 col-12 back container w-50 my-4 rounded">
                    <div id="tablepanel" class="choice_table rounded text-white">                        
                        <div class="choice_table rounded text-white">
                            ...
                            <option value='<?= $mmtsysNo ?>' selected><?= $mmtsysName ?>-每日檢查紀錄表</option>
                            </select>
                            <!--工程名稱 -->
                            <P>保養設備大樓: </P>                                 
                            <select class="form-control mb-3" name="mmtbuilda" id="mmtbuildb" required>
                                <!--f1-->
                                <option selected>請選擇大樓</option> 
                            </select>
                            <!-- 送出鍵 -->
                            <div class="d-flex justify-content-end">                                
                                <span class="billBoardwaterL1 billBoardwaterL2 billBoardwaterL3" tabindex="0" data-toggle="tooltip" data-placement="bottom"
                                    title="請登入相應權限帳號已解鎖">
                                    <button style="pointer-events: none;" type="submit"
                                        class="btn btn-primary mt-4 waterL1 waterL2 waterL3" formtarget="_self" disabled>送出</button>
                                </span>
                            </div>
                        </div>
                    </div>
