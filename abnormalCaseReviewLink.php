        ...
        $totalstr_num="SELECT COUNT(DISTINCT(a.case_id)) FROM FA.Abnormal_Notification_System_Master AS a LEFT JOIN FA.Abnormal_Notification_System_Detail AS b ON a.case_id=b.case_id  WHERE a.manage_status IS NULL AND b.Detail_End_Time IS NOT NULL";        
            ...
            switch ($x) {
                ...
                case 1://只有keyword
                    ...
                    $sqlstr_total="SELECT DISTINCT(a.case_id), a.*,b.Detail_id,b.Detail_Start_Time,b.Detail_End_Time FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Abnormal_Notification_System_Detail AS b ON a.case_id=b.case_id LEFT JOIN FA.Employee as c on a.case_userID=c.e_number or a.case_manageID=c.e_number or a.work_emp=c.e_number LEFT JOIN FA.CheckStatus as p ON a.manage_status=p.id where ( c.cname like '%$keyword%' or a.case_title like '%$keyword%' or a.case_location like '%$keyword%' or a.case_time like '%$keyword%' or a.confirm_date like '%$keyword%'or p.checkName like '%$keyword%') AND (a.manage_status IS NULL AND b.Detail_End_Time IS NOT NULL)";
                    //篩選後給每頁的筆數
                    $sqlstr_page="SELECT DISTINCT(a.case_id), a.*,b.Detail_id,b.Detail_Start_Time,b.Detail_End_Time FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Abnormal_Notification_System_Detail AS b ON a.case_id=b.case_id LEFT JOIN FA.Employee as c on a.case_userID=c.e_number or a.case_manageID=c.e_number or a.work_emp=c.e_number LEFT JOIN FA.CheckStatus as p ON a.manage_status=p.id where ( c.cname like '%$keyword%' or a.case_title like '%$keyword%' or a.case_location like '%$keyword%' or a.case_time like '%$keyword%' or a.confirm_date like '%$keyword%'or p.checkName like '%$keyword%') AND (a.manage_status IS NULL AND b.Detail_End_Time IS NOT NULL) ORDER BY a.case_time DESC OFFSET $startRow_record ROWS FETCH NEXT $pageRow_record ROWS ONLY";
                   //總資料數量
                ...
                case 5://開始+keyword
                    //所有的資料 (check_manager IS NULL or check_manager=0) and
                    $sqlstr_total=" SELECT DISTINCT(a.case_id), a.*,b.Detail_id,b.Detail_Start_Time,b.Detail_End_Time FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Abnormal_Notification_System_Detail AS b ON a.case_id=b.case_id LEFT JOIN FA.Employee as c on a.case_userID=c.e_number or a.case_manageID=c.e_number or a.work_emp=c.e_number LEFT JOIN FA.CheckStatus as p ON a.manage_status=p.id where ((a.case_time ='$start_date'or a.confirm_date= '$start_date') and ( c.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%'or p.checkName like '%$keyword%')) AND (a.manage_status IS NULL AND b.Detail_End_Time IS NOT NULL)";
                    //篩選後給每頁的筆數
                    $sqlstr_page="SELECT DISTINCT(a.case_id), a.*,b.Detail_id,b.Detail_Start_Time,b.Detail_End_Time FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Abnormal_Notification_System_Detail AS b ON a.case_id=b.case_id LEFT JOIN FA.Employee as c on a.case_userID=c.e_number or a.case_manageID=c.e_number or a.work_emp=c.e_number LEFT JOIN FA.CheckStatus as p ON a.manage_status=p.id where ((a.case_time ='$start_date'or a.confirm_date = '$start_date') and ( c.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%'or p.checkName like '%$keyword%')) AND (a.manage_status IS NULL AND b.Detail_End_Time IS NOT NULL) ORDER BY a.case_time DESC OFFSET $startRow_record ROWS FETCH NEXT $pageRow_record ROWS ONLY";
                    //總資料數量
                    $totalstr_num="SELECT COUNT(DISTINCT(a.case_id)) FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Abnormal_Notification_System_Detail AS b ON a.case_id=b.case_id LEFT JOIN FA.Employee as c on a.case_userID=c.e_number or a.case_manageID=c.e_number or a.work_emp=c.e_number LEFT JOIN FA.CheckStatus as p ON a.manage_status=p.id where ((a.case_time ='$start_date'or a.confirm_date = '$start_date') and ( c.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%'or p.checkName like '%$keyword%')) AND (a.manage_status IS NULL AND b.Detail_End_Time IS NOT NULL)";
                    break;
                case 6://結束+keyword
                    //所有的資料 (check_manager IS NULL or check_manager=0) and
                    $sqlstr_total=" SELECT DISTINCT(a.case_id), a.*,b.Detail_id,b.Detail_Start_Time,b.Detail_End_Time FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Abnormal_Notification_System_Detail AS b ON a.case_id=b.case_id LEFT JOIN FA.Employee as c on a.case_userID=c.e_number or a.case_manageID=c.e_number or a.work_emp=c.e_number LEFT JOIN FA.CheckStatus as p ON a.manage_status=p.id where ((a.case_time='$end_date'or a.confirm_date = '$end_date')  and ( c.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%'or p.checkName like '%$keyword%')) AND (a.manage_status IS NULL AND b.Detail_End_Time IS NOT NULL)";
                    //篩選後給每頁的筆數
                    $sqlstr_page="SELECT DISTINCT(a.case_id), a.*,b.Detail_id,b.Detail_Start_Time,b.Detail_End_Time FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Abnormal_Notification_System_Detail AS b ON a.case_id=b.case_id LEFT JOIN FA.Employee as c on a.case_userID=c.e_number or a.case_manageID=c.e_number or a.work_emp=c.e_number LEFT JOIN FA.CheckStatus as p ON a.manage_status=p.id where ((a.case_time='$end_date'or a.confirm_date = '$end_date')  and ( c.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%'or p.checkName like '%$keyword%')) AND (a.manage_status IS NULL AND b.Detail_End_Time IS NOT NULL) ORDER BY a.case_time DESC OFFSET $startRow_record ROWS FETCH NEXT $pageRow_record ROWS ONLY";
                    //總資料數量
                    $totalstr_num="SELECT COUNT(DISTINCT(a.case_id)) FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Abnormal_Notification_System_Detail AS b ON a.case_id=b.case_id LEFT JOIN FA.Employee as c on a.case_userID=c.e_number or a.case_manageID=c.e_number or a.work_emp=c.e_number LEFT JOIN FA.CheckStatus as p ON a.manage_status=p.id where ((a.case_time='$end_date'or a.confirm_date = '$end_date')  and ( c.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%'or p.checkName like '%$keyword%')) AND (a.manage_status IS NULL AND b.Detail_End_Time IS NOT NULL)";
                    break;
                case 7://日期區間+keyword
                    //所有的資料 (check_manager IS NULL or check_manager=0) and
                    $sqlstr_total=" SELECT DISTINCT(a.case_id), a.*,b.Detail_id,b.Detail_Start_Time,b.Detail_End_Time FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Abnormal_Notification_System_Detail AS b ON a.case_id=b.case_id LEFT JOIN FA.Employee as c on a.case_userID=c.e_number or a.case_manageID=c.e_number or a.work_emp=c.e_number LEFT JOIN FA.CheckStatus as p ON a.manage_status=p.id where ( (a.case_time between '$start_date' and '$end_date' or a.confirm_date between '$start_date' and '$end_date')and (c.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%'or p.checkName like '%$keyword%')) AND (a.manage_status IS NULL AND b.Detail_End_Time IS NOT NULL)";
                    //篩選後給每頁的筆數
                    $sqlstr_page="SELECT DISTINCT(a.case_id), a.*,b.Detail_id,b.Detail_Start_Time,b.Detail_End_Time FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Abnormal_Notification_System_Detail AS b ON a.case_id=b.case_id LEFT JOIN FA.Employee as c on a.case_userID=c.e_number or a.case_manageID=c.e_number or a.work_emp=c.e_number LEFT JOIN FA.CheckStatus as p ON a.manage_status=p.id where ( (a.case_time between '$start_date' and '$end_date' or a.confirm_date between '$start_date' and '$end_date')and (c.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%'or p.checkName like '%$keyword%')) AND (a.manage_status IS NULL AND b.Detail_End_Time IS NOT NULL) ORDER BY a.case_time DESC OFFSET $startRow_record ROWS FETCH NEXT $pageRow_record ROWS ONLY";
                    //總資料數量
                    $totalstr_num="SELECT COUNT(DISTINCT(a.case_id)) FROM FA.Abnormal_Notification_System_Master as a LEFT JOIN FA.Abnormal_Notification_System_Detail AS b ON a.case_id=b.case_id LEFT JOIN FA.Employee as c on a.case_userID=c.e_number or a.case_manageID=c.e_number or a.work_emp=c.e_number LEFT JOIN FA.CheckStatus as p ON a.manage_status=p.id where ( (a.case_time between '$start_date' and '$end_date' or a.confirm_date between '$start_date' and '$end_date')and (c.cname like '%$keyword%' or a.case_title like '%$keyword%'  or a.case_location like '%$keyword%'or p.checkName like '%$keyword%')) AND (a.manage_status IS NULL AND b.Detail_End_Time IS NOT NULL)";
                    break;                
            }
