...
//所有的資料
$ammtmstr="SELECT id,bid,fid,eid,rdate,datekind,tid,macNo,remark,emp,cemp,status FROM FA.MMT_AtableM ";//全部資料
//總資料數量
...
//----還沒帶入----
//篩選後給每頁的筆數
$sqlstr_page="SELECT id,bid,fid,eid,rdate,datekind,tid,macNo,remark,emp,cemp,status FROM FA.MMT_AtableM  ORDER BY rdate ASC OFFSET $startRow_record ROWS FETCH NEXT $pageRow_record ROWS ONLY";
