...
$Q_A_str="SELECT d.id,a.checkName,a.checkKind,a.ref,d.ans FROM FA.MMT_A AS a LEFT JOIN FA.MMT_PtableD as d ON a.id=d.checkid WHERE d.mid='$MMT_AtableMid' ORDER BY a.id";
...
if (isset($_POST["action"])&&($_POST["action"]=="Edit")) {
    ...
    $MasterStr="UPDATE FA.MMT_PtableM SET datekind=:datekind,remark=:remark WHERE id=:mid";
    ...
    for ($i=0; $i < $num; $i++) { 
        ...
        $ans=$_POST["$i"];//答案
        $sql="UPDATE FA.MMT_PtableD SET ans=:checkResult WHERE id=:ID";
